...
test_MLP_data = [
    {'input_dim': 10, 'output_dim': 15, 'nodes_per_layer': 100, 'num_layers': 2},
    {'input_dim': 10, 'output_dim': 15, 'nodes_per_layer': 123, 'num_layers': 2},
    {'input_dim': 10, 'output_dim': 15, 'nodes_per_layer': [100, 200, 300], 'num_layers': 2},
]
...
def test_MLP(test_MLP_data):
    ...
    model = MLP({}, input_dim=test_MLP_data['input_dim'], output_dim=test_MLP_data['output_dim'], nodes_per_layer=test_MLP_data['nodes_per_layer'], num_layers=test_MLP_data['num_layers'])
